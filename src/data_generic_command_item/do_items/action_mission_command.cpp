...
std::shared_ptr<command_item::AbstractCommandItem> ActionMissionCommand::getClone() const
{
    return std::make_shared<ActionMissionCommand>(*this);
}

void ActionMissionCommand::getClone(std::shared_ptr<command_item::AbstractCommandItem> &command) const
{
