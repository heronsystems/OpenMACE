#-------------------------------------------------
#
# Project created by QtCreator 2018-11-29T13:45:22
#
#-------------------------------------------------

QT       -= gui

TARGET = task_management_topic
TEMPLATE = lib


QMAKE_CXXFLAGS += -std=c++11

DEFINES += TASK_MANAGEMENT_TOPIC_LIBRARY
...
SOURCES += \
    task_assignment_topic.cpp \
    vehicle_task_status_topic.cpp

HEADERS += \
    task_assignment_topic.h \
    vehicle_task_status_topic.h \
    task_management_components.h
...
win32:CONFIG(release, debug|release):       lib.files   += release/task_management_topic.lib release/task_management_topic.dll
else:win32:CONFIG(debug, debug|release):    lib.files   += debug/task_management_topic.lib debug/task_management_topic.dll
INSTALLS += lib
