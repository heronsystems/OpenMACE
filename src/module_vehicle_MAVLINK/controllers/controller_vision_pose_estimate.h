#ifndef CONTROLLER_VISION_POSE_ESTIMATE_H
#define CONTROLLER_VISION_POSE_ESTIMATE_H
...
using VisionPoseEstimateBroadcast = Controllers::ActionBroadcast<
    mavlink_message_t,
    MavlinkEntityKey,
...
class Controller_VisionPoseEstimate : public BasicMavlinkController_ModuleKeyed<command_item::Action_DynamicTarget>,
...
#endif // CONTROLLER_VISION_POSE_ESTIMATE_H
