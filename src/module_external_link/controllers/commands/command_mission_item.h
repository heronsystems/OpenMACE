...
class CommandMissionItem : public Controller_GenericShortCommand<command_item::ActionMissionCommand, (uint8_t)command_item::COMMANDTYPE::CI_ACT_MISSIONCOMMAND>
{
public:
