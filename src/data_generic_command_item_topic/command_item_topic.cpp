...
const MaceCore::TopicComponentStructure CommandItemTopic_structure = []{
    ...
    structure.AddTerminal<std::shared_ptr<CommandItem::AbstractCommandItem>>("commandItem");
    return structure;
}();

MaceCore::TopicDatagram CommandItemTopic::GenerateDatagram() const {
    MaceCore::TopicDatagram datagram;
    datagram.AddTerminal<std::shared_ptr<CommandItem::AbstractCommandItem>>("commandItem", commandItem);
    return datagram;
}

void CommandItemTopic::CreateFromDatagram(const MaceCore::TopicDatagram &datagram)
{
    commandItem = datagram.GetTerminal<std::shared_ptr<CommandItem::AbstractCommandItem>>("commandItem");
}
