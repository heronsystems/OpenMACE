#-------------------------------------------------
#
# Project created by QtCreator 2019-04-08T10:51:53
#
#-------------------------------------------------
...
TARGET = example_vehicle_module
TEMPLATE = lib

DEFINES += EXAMPLE_VEHICLE_MODULE_LIBRARY
...
SOURCES += example_vehicle_module.cpp

HEADERS += example_vehicle_module.h\
        example_vehicle_module_global.h
...
else:unix:!macx: LIBS += -L$$OUT_PWD/../commsExample/ -lcommsExample
