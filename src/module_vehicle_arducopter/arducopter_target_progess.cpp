...
ArducopterTargetProgess::ArducopterTargetProgess()
{
...
ArducopterTargetProgess::ArducopterTargetProgess(const double &achievedDistance, const double &huntingDistance, const double &maxHuntingDuration) :
...
Data::ControllerState ArducopterTargetProgess::newTargetItem(const double &distance)
{
...
//Data::ControllerState ArducopterTargetProgess::updateTargetTimes()
//{
//}

Data::ControllerState ArducopterTargetProgess::updateTargetState(const double &distance)
{
...
void ArducopterTargetProgess::initializeTargetState()
{
    targetStart = std::chrono::system_clock::now();
    huntingStart = std::chrono::system_clock::now();
}

void ArducopterTargetProgess::initializeTargetStart()
{
    targetStart = std::chrono::system_clock::now();
}

float ArducopterTargetProgess::getCurrentTargetTime()
{
...
float ArducopterTargetProgess::getHuntingTime()
{
    std::chrono::time_point<std::chrono::system_clock> now;
    now = std::chrono::system_clock::now();
