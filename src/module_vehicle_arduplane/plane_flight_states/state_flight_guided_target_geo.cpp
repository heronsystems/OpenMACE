...
AbstractStateArdupilot* AP_State_FlightGuided_GeoTarget::getClone() const
{
    return (new AP_State_FlightGuided_GeoTarget(*this));
}

void AP_State_FlightGuided_GeoTarget::getClone(AbstractStateArdupilot** state) const
{
    *state = new AP_State_FlightGuided_GeoTarget(*this);
}

hsm::Transition AP_State_FlightGuided_GeoTarget::GetTransition()
{
...
bool AP_State_FlightGuided_GeoTarget::handleCommand(const std::shared_ptr<command_item::AbstractCommandItem> command)
{
...
void AP_State_FlightGuided_GeoTarget::Update()
{

}

void AP_State_FlightGuided_GeoTarget::OnEnter()
{
    /*
...
void AP_State_FlightGuided_GeoTarget::OnEnter(const std::shared_ptr<command_item::AbstractCommandItem> command)
{
    if(command == nullptr)
    {
        this->OnEnter();
