...
AP_State_FlightGuided_AttTarget::AP_State_FlightGuided_AttTarget():
    AbstractStateArdupilot(), m_TimeoutController(10)
{
    ...
    m_TimeoutController.connectTargetCallback(AP_State_FlightGuided_AttTarget::retransmitGuidedCommand, this);
    Data::EnvironmentTime::CurrentTime(Data::Devices::SYSTEMCLOCK, previousTime);

}

void AP_State_FlightGuided_AttTarget::OnExit()
{
...
AbstractStateArdupilot* AP_State_FlightGuided_AttTarget::getClone() const
{
    return (new AP_State_FlightGuided_AttTarget(*this));
}

void AP_State_FlightGuided_AttTarget::getClone(AbstractStateArdupilot** state) const
{
    *state = new AP_State_FlightGuided_AttTarget(*this);
}

hsm::Transition AP_State_FlightGuided_AttTarget::GetTransition()
{
...
void AP_State_FlightGuided_AttTarget::Update()
{

}

void AP_State_FlightGuided_AttTarget::OnEnter()
{
    /*
