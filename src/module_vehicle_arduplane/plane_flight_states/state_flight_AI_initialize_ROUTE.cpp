...
hsm::Transition AP_State_FlightAI_Initialize_ROUTE::GetTransition()
{
    ...
    if(currentStateEnum != desiredStateEnum)
    {
        ...
        {
            rtn = hsm::InnerTransition<AP_State_FlightAI_Initialize_ROUTE_Idle>(currentCommand);
            break;
        }
        case Data::MACEHSMState::STATE_FLIGHT_AI_INITIALIZE:
        {
            rtn = hsm::InnerTransition<AP_State_FlightAI_Initialize_ROUTE_Initialize>(currentCommand);
            break;
        }
        case Data::MACEHSMState::STATE_FLIGHT_AI_DEFLECTION:
        {
            rtn = hsm::InnerTransition<AP_State_FlightAI_Initialize_ROUTE_Deflection>(currentCommand);
            break;
        }
        case Data::MACEHSMState::STATE_FLIGHT_AI_END:
        {
            rtn = hsm::InnerTransition<AP_State_FlightAI_Initialize_ROUTE_EvalEnd>(currentCommand);
            break;
        }
        default:
