...
AP_State_FlightGuided_SpatialItem::AP_State_FlightGuided_SpatialItem():
...
void AP_State_FlightGuided_SpatialItem::OnExit()
{
...
AbstractStateArdupilot* AP_State_FlightGuided_SpatialItem::getClone() const
{
    return (new AP_State_FlightGuided_SpatialItem(*this));
}

void AP_State_FlightGuided_SpatialItem::getClone(AbstractStateArdupilot** state) const
{
    *state = new AP_State_FlightGuided_SpatialItem(*this);
}

hsm::Transition AP_State_FlightGuided_SpatialItem::GetTransition()
{
    ...
    if(currentStateEnum != desiredStateEnum)
    {
        ...
        {
            rtn = hsm::SiblingTransition<AP_State_FlightGuided_Idle>();
            break;
        }
        default:
...
void AP_State_FlightGuided_SpatialItem::Update()
{

}

void AP_State_FlightGuided_SpatialItem::OnEnter()
{
    /*
