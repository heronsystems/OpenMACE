#ifndef AP_STATE_FLIGHT_GUIDED_TARGET_CAR_H
#define AP_STATE_FLIGHT_GUIDED_TARGET_CAR_H
...
class AP_State_FlightGuided_CarTarget : public AbstractStateArdupilot
{
public:
    AP_State_FlightGuided_CarTarget();
...
private:
    ...
    {
        static_cast<AP_State_FlightGuided_CarTarget*>(p)->constructAndSendTarget(target);
    }
...
#endif // AP_STATE_FLIGHT_GUIDED_TARGET_CAR_H
