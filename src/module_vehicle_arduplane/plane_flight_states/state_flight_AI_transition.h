#ifndef AP_STATE_FLIGHT_AI_TRANSITION_H
#define AP_STATE_FLIGHT_AI_TRANSITION_H
...
class AP_State_FlightAI_Transition : public AbstractStateArdupilot
{
public:
    AP_State_FlightAI_Transition();
