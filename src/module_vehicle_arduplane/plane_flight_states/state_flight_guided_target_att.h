#ifndef AP_STATE_FLIGHT_GUIDED_TARGET_ATT_H
#define AP_STATE_FLIGHT_GUIDED_TARGET_ATT_H
...
#include "controllers/controllers_MAVLINK/controller_guided_target_item_attitude.h"
...
class AP_State_FlightGuided_AttTarget : public AbstractStateArdupilot
{
public:
    AP_State_FlightGuided_AttTarget();
...
private:
    ...
    {
        static_cast<AP_State_FlightGuided_AttTarget*>(p)->constructAndSendTarget(target);
    }
...
#endif // AP_STATE_FLIGHT_GUIDED_TARGET_ATT_H
