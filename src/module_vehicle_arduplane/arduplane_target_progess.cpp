#include "arduplane_target_progess.h"

ArduplaneTargetProgess::ArduplaneTargetProgess()
{
...
ArduplaneTargetProgess::ArduplaneTargetProgess(const double &achievedDistance, const double &huntingDistance, const double &maxHuntingDuration) :
...
Data::ControllerState ArduplaneTargetProgess::newTargetItem(const double &distance)
{
...
//Data::ControllerState ArduplaneTargetProgess::updateTargetTimes()
//{
//}

Data::ControllerState ArduplaneTargetProgess::updateTargetState(const double &distance)
{
...
void ArduplaneTargetProgess::initializeTargetState()
{
    targetStart = std::chrono::system_clock::now();
    huntingStart = std::chrono::system_clock::now();
}

void ArduplaneTargetProgess::initializeTargetStart()
{
    targetStart = std::chrono::system_clock::now();
}

float ArduplaneTargetProgess::getCurrentTargetTime()
{
...
float ArduplaneTargetProgess::getHuntingTime()
{
    std::chrono::time_point<std::chrono::system_clock> now;
    now = std::chrono::system_clock::now();
