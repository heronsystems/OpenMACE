#ifndef MODULE_VEHICLE_ARDUPLANE_H
#define MODULE_VEHICLE_ARDUPLANE_H
...
#include "module_vehicle_arduplane_global.h"
...
#include "flight_states/arduplane_hsm.h"
...
class MODULE_VEHICLE_ARDUPLANESHARED_EXPORT ModuleVehicleArduplane : public ModuleVehicleMAVLINK<>
{
public:
    ModuleVehicleArduplane();


    virtual ~ModuleVehicleArduplane() override;
...
#endif // MODULE_VEHICLE_ARDUPLANE_H
