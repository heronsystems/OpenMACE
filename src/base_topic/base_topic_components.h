...
#define BASE_POSE_TOPICS mace::pose_topics::Topic_CartesianPosition, mace::pose_topics::Topic_GeodeticPosition, mace::pose_topics::Topic_CartesianVelocity, mace::pose_topics::Topic_AgentOrientation
