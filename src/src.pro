...
module_vehicle_generic.depends = common comms data mace_core data_generic_item data_generic_command_item data_generic_item_topic data_generic_command_item_topic data_generic_mission_item_topic
