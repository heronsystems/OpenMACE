...
module_ml_station.depends = base mace_core comms data data_vehicle_sensors data_generic_item data_generic_item_topic data_generic_command_item data_generic_command_item_topic data_generic_mission_item_topic base_topic
