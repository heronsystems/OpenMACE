...
enum class ArdupilotFlightState{
    ...
    STATE_FLIGHT_AUTO = 18, /**< */
    STATE_FLIGHT_BRAKE= 19, /**< */
    STATE_FLIGHT_RTL = 20, /**< */
    STATE_FLIGHT_LAND = 21,
    STATE_FLIGHT_UNKNOWN = 22,
    STATE_LANDING= 23, /**< */
    STATE_LANDING_TRANSITIONING = 24, /**< */
    STATE_LANDING_DESCENDING = 25, /**< */
    STATE_LANDING_COMPLETE = 26, /**< */
    STATE_UNKNOWN = 27 /**< */
};
