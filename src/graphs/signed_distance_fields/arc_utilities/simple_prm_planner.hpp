...
namespace simple_prm_planner
{
    ...
    public:
        ...
        {
            arc_dijkstras::Graph<T, Allocator> roadmap;
            ExtendRoadMap(roadmap, sampling_fn, distance_fn, state_validity_check_fn, edge_validity_check_fn, termination_check_fn, K, distance_is_symmetric, add_duplicate_states);
            return roadmap;
        }
