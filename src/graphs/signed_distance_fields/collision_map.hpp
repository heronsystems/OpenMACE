...
public:
    ...
    sdf_generation::DistanceField ExtractDistanceField(const float oob_value) const
    {
        ...
        sdf_generation::DistanceField filled_distance_field = sdf_generation::BuildDistanceField(GetOriginTransform(),GetResolution(),GetNumXCells(),GetNumYCells(),GetNumZCells(),filled);
