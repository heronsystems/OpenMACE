...
//    m_Link = new MACEDigiMeshWrapper<MACE_INSTANCE_STR, VEHICLE_STR, GROUNDSTATION_STR, MLSTATION_STR, RTA_STR, EXTERNAL_LINK_STR, ADEPT>(_config.portName(), _config.baud());
