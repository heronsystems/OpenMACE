#ifndef MODULE_EXTERNAL_LINK_GENERIC_H
#define MODULE_EXTERNAL_LINK_GENERIC_H

#include "module_external_link_generic_global.h"
...
class IExternalLinkSubModule
{
public:
    virtual std::vector<MaceCore::TopicCharacteristic> GetEmittedTopics() const = 0;

    virtual void AttachedAsModule(MaceCore::IModuleTopicEvents* ptr) = 0;
};


class MODULE_EXTERNAL_LINK_GENERICSHARED_EXPORT ModuleExternalLinkGeneric :
...
protected:
    ...
    Controllers::MessageModuleTransmissionQueue<mace_message_t> *m_queue;

private:
    std::vector<IExternalLinkSubModule*> m_SubModules;
...
#endif // MODULE_EXTERNAL_LINK_GENERIC_H
