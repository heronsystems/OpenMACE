#-------------------------------------------------
#
# Project created by QtCreator 2018-11-27T11:42:27
#
#-------------------------------------------------
...
TARGET = module_task_generation
TEMPLATE = lib

DEFINES += MODULE_TASK_GENERATION_LIBRARY
...
SOURCES += \
    module_task_generation.cpp

HEADERS += \
    module_task_generation_global.h \
    module_task_generation.h
...
win32:CONFIG(release, debug|release):       lib.files   += release/module_task_generation.lib release/module_task_generation.dll
else:win32:CONFIG(debug, debug|release):    lib.files   += debug/module_task_generation.lib debug/module_task_generation.dll
INSTALLS += lib
