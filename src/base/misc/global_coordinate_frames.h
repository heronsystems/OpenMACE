...
CF_GLOBAL_AMSL, /* Global coordinate frame, WGS84 coordinate system. First value / x: latitude in degrees, second value / y: longitude in degrees, third value / z: mean sea level (MSL) | */ \
