// MESSAGE AUCTION_TASK_DESCRIPTOR_ACK support class
...
/**
 * @brief AUCTION_TASK_DESCRIPTOR_ACK message
 *
 * 
 */
struct AUCTION_TASK_DESCRIPTOR_ACK : mavlink::Message {
    static constexpr msgid_t MSG_ID = 10052;
    static constexpr size_t LENGTH = 17;
    static constexpr size_t MIN_LENGTH = 17;
    static constexpr uint8_t CRC_EXTRA = 214;
    static constexpr auto NAME = "AUCTION_TASK_DESCRIPTOR_ACK";
