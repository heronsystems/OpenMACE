...
#define MACE_MSG_ID_AUCTION_BID_BUNDLE_NEXT_PART_LEN 84
#define MACE_MSG_ID_AUCTION_BID_BUNDLE_NEXT_PART_MIN_LEN 84
#define MACE_MSG_ID_10001_LEN 84
#define MACE_MSG_ID_10001_MIN_LEN 84

#define MACE_MSG_ID_AUCTION_BID_BUNDLE_NEXT_PART_CRC 74
#define MACE_MSG_ID_10001_CRC 74
...
#define MACE_MESSAGE_INFO_AUCTION_BID_BUNDLE_NEXT_PART { \
    ...
    {  { "requestFrom", NULL, MACE_TYPE_UINT64_T, 0, 0, offsetof(mace_auction_bid_bundle_next_part_t, requestFrom) }, \
         ...
         { "bidGenTime", NULL, MACE_TYPE_DOUBLE, 0, 24, offsetof(mace_auction_bid_bundle_next_part_t, bidGenTime) }, \
         { "utility", NULL, MACE_TYPE_DOUBLE, 0, 32, offsetof(mace_auction_bid_bundle_next_part_t, utility) }, \
         { "work", NULL, MACE_TYPE_DOUBLE, 0, 40, offsetof(mace_auction_bid_bundle_next_part_t, work) }, \
         { "cost", NULL, MACE_TYPE_DOUBLE, 0, 48, offsetof(mace_auction_bid_bundle_next_part_t, cost) }, \
         { "reward", NULL, MACE_TYPE_DOUBLE, 0, 56, offsetof(mace_auction_bid_bundle_next_part_t, reward) }, \
         { "creatorID", NULL, MACE_TYPE_UINT64_T, 0, 64, offsetof(mace_auction_bid_bundle_next_part_t, creatorID) }, \
         { "taskGenTime", NULL, MACE_TYPE_DOUBLE, 0, 72, offsetof(mace_auction_bid_bundle_next_part_t, taskGenTime) }, \
         { "taskID", NULL, MACE_TYPE_UINT8_T, 0, 80, offsetof(mace_auction_bid_bundle_next_part_t, taskID) }, \
         { "type", NULL, MACE_TYPE_UINT8_T, 0, 81, offsetof(mace_auction_bid_bundle_next_part_t, type) }, \
         { "priority", NULL, MACE_TYPE_UINT8_T, 0, 82, offsetof(mace_auction_bid_bundle_next_part_t, priority) }, \
         { "seqNum", NULL, MACE_TYPE_INT8_T, 0, 83, offsetof(mace_auction_bid_bundle_next_part_t, seqNum) }, \
         } \
}
#else
#define MACE_MESSAGE_INFO_AUCTION_BID_BUNDLE_NEXT_PART { \
...
static inline uint16_t mace_msg_auction_bid_bundle_next_part_pack(uint8_t system_id, uint8_t component_id, mace_message_t* msg,
                               uint64_t requestFrom, uint64_t agentID, double bundleGenTime, double bidGenTime, double utility, double work, double cost, double reward, uint64_t creatorID, uint8_t taskID, double taskGenTime, uint8_t type, uint8_t priority, int8_t seqNum)
{
    ...
    _mace_put_double(buf, 24, bidGenTime);
    _mace_put_double(buf, 32, utility);
    _mace_put_double(buf, 40, work);
    _mace_put_double(buf, 48, cost);
    _mace_put_double(buf, 56, reward);
    _mace_put_uint64_t(buf, 64, creatorID);
    _mace_put_double(buf, 72, taskGenTime);
    _mace_put_uint8_t(buf, 80, taskID);
    _mace_put_uint8_t(buf, 81, type);
    _mace_put_uint8_t(buf, 82, priority);
    _mace_put_int8_t(buf, 83, seqNum);
...
static inline void mace_msg_auction_bid_bundle_next_part_send(mace_channel_t chan, uint64_t requestFrom, uint64_t agentID, double bundleGenTime, double bidGenTime, double utility, double work, double cost, double reward, uint64_t creatorID, uint8_t taskID, double taskGenTime, uint8_t type, uint8_t priority, int8_t seqNum)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    char buf[MACE_MSG_ID_AUCTION_BID_BUNDLE_NEXT_PART_LEN];
    _mace_put_uint64_t(buf, 0, requestFrom);
...
/**
 * @brief Get field bidGenTime from auction_bid_bundle_next_part message
 *
 * @return Bid generation time
 */
static inline double mace_msg_auction_bid_bundle_next_part_get_bidGenTime(const mace_message_t* msg)
{
...
{
    return _MACE_RETURN_uint64_t(msg,  64);
}
...
{
    return _MACE_RETURN_uint8_t(msg,  80);
}
...
{
    return _MACE_RETURN_double(msg,  72);
}
...
{
    return _MACE_RETURN_uint8_t(msg,  81);
}
...
{
    return _MACE_RETURN_uint8_t(msg,  82);
}
...
{
    return _MACE_RETURN_int8_t(msg,  83);
}
...
static inline void mace_msg_auction_bid_bundle_next_part_decode(const mace_message_t* msg, mace_auction_bid_bundle_next_part_t* auction_bid_bundle_next_part)
{
    ...
    auction_bid_bundle_next_part->bidGenTime = mace_msg_auction_bid_bundle_next_part_get_bidGenTime(msg);
