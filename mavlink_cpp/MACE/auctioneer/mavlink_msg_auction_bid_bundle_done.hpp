// MESSAGE AUCTION_BID_BUNDLE_DONE support class
...
/**
 * @brief AUCTION_BID_BUNDLE_DONE message
 *
 * Notification that a bid bundle has been fully sent
 */
struct AUCTION_BID_BUNDLE_DONE : mavlink::Message {
    static constexpr msgid_t MSG_ID = 10003;
    static constexpr size_t LENGTH = 16;
    static constexpr size_t MIN_LENGTH = 16;
    static constexpr uint8_t CRC_EXTRA = 174;
    static constexpr auto NAME = "AUCTION_BID_BUNDLE_DONE";
