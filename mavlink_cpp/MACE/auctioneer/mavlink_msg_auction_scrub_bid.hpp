// MESSAGE AUCTION_SCRUB_BID support class
...
/**
 * @brief AUCTION_SCRUB_BID message
 *
 * Message to clear a bid
 */
struct AUCTION_SCRUB_BID : mavlink::Message {
    static constexpr msgid_t MSG_ID = 10013;
    static constexpr size_t LENGTH = 25;
    static constexpr size_t MIN_LENGTH = 25;
    static constexpr uint8_t CRC_EXTRA = 229;
    static constexpr auto NAME = "AUCTION_SCRUB_BID";
