...
#define MACE_MSG_ID_AUCTION_REQUEST_TASK_DESCRIPTOR_LEN 17
#define MACE_MSG_ID_AUCTION_REQUEST_TASK_DESCRIPTOR_MIN_LEN 17
#define MACE_MSG_ID_10007_LEN 17
#define MACE_MSG_ID_10007_MIN_LEN 17

#define MACE_MSG_ID_AUCTION_REQUEST_TASK_DESCRIPTOR_CRC 22
#define MACE_MSG_ID_10007_CRC 22
...
#define MACE_MESSAGE_INFO_AUCTION_REQUEST_TASK_DESCRIPTOR { \
    ...
    {  { "requestFrom", NULL, MACE_TYPE_UINT64_T, 0, 0, offsetof(mace_auction_request_task_descriptor_t, requestFrom) }, \
         ...
         { "taskID", NULL, MACE_TYPE_UINT8_T, 0, 16, offsetof(mace_auction_request_task_descriptor_t, taskID) }, \
         } \
}
#else
#define MACE_MESSAGE_INFO_AUCTION_REQUEST_TASK_DESCRIPTOR { \
...
static inline uint16_t mace_msg_auction_request_task_descriptor_pack(uint8_t system_id, uint8_t component_id, mace_message_t* msg,
                               uint64_t requestFrom, uint64_t creatorID, uint8_t taskID)
{
...
static inline void mace_msg_auction_request_task_descriptor_send(mace_channel_t chan, uint64_t requestFrom, uint64_t creatorID, uint8_t taskID)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    char buf[MACE_MSG_ID_AUCTION_REQUEST_TASK_DESCRIPTOR_LEN];
    _mace_put_uint64_t(buf, 0, requestFrom);
 ...
 */
static inline void mace_msg_auction_request_task_descriptor_send_buf(mace_message_t *msgbuf, mace_channel_t chan,  uint64_t requestFrom, uint64_t creatorID, uint8_t taskID)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
 ...
 */
static inline uint8_t mace_msg_auction_request_task_descriptor_get_taskID(const mace_message_t* msg)
{
