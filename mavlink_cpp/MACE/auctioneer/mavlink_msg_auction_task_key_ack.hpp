// MESSAGE AUCTION_TASK_KEY_ACK support class
...
/**
 * @brief AUCTION_TASK_KEY_ACK message
 *
 * Acknowledgment of a new task key
 */
struct AUCTION_TASK_KEY_ACK : mavlink::Message {
    ...
    static constexpr auto NAME = "AUCTION_TASK_KEY_ACK";
