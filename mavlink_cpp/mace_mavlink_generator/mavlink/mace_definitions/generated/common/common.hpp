...
{
    GLOBAL_UNKNOWN=0, /* Global coordinate frame, WGS84 coordinate system. First value / x: latitude, second value / y: longitude, third value / z: positive altitude over mean sea level (MSL) | */
    GLOBAL_AMSL=1, /* Global coordinate frame, WGS84 coordinate system. First value / x: latitude, second value / y: longitude, third value / z: positive altitude over mean sea level (MSL) | */
    GLOBAL_AMSL_INT=2, /* Global coordinate frame, WGS84 coordinate system. First value / x: latitude in degrees*1.0e-7, second value / y: longitude in degrees*1.0e-7, third value / z: positive altitude over mean sea level (MSL) | */
    ...
    GLOBAL_RELATIVE_ALT_INT=4, /* Global coordinate frame, WGS84 coordinate system, relative altitude over ground with respect to the home position. First value / x: latitude in degrees*10e-7, second value / y: longitude in degrees*10e-7, third value / z: positive altitude with 0 being at the altitude of the home location. | */
    GLOBAL_TERRAIN_ALT=5, /* Global coordinate frame with above terrain level altitude. WGS84 coordinate system, relative altitude over terrain with respect to the waypoint coordinate. First value / x: latitude in degrees, second value / y: longitude in degrees, third value / z: positive altitude in meters with 0 being at ground level in terrain model. | */
    GLOBAL_TERRAIN_ALT_INT=6, /* Global coordinate frame with above terrain level altitude. WGS84 coordinate system, relative altitude over terrain with respect to the waypoint coordinate. First value / x: latitude in degrees*10e-7, second value / y: longitude in degrees*10e-7, third value / z: positive altitude in meters with 0 being at ground level in terrain model. | */
    LOCAL_UNKNOWN=10, /* Local coordinate frame, Z-up (x: north, y: east, z: down). | */
    LOCAL_NED=11, /* Local coordinate frame, Z-up (x: north, y: east, z: down). | */
    LOCAL_ENU=12, /* Local coordinate frame, Z-down (x: east, y: north, z: up) | */
    LOCAL_OFFSET_NED=13, /* Position relative to the current vehicle position. Velocity is relative to the origin NED.  | */
    LOCAL_OFFSET_ENU=14, /* Position relative to the current vehicle position. Velocity is relative to the origin NED.  | */
    BODY_NED=15, /* Positions are relative to the origin. Velocities are relative to the current vehicle heading. | */
    BODY_ENU=16, /* Positions are relative to the origin. Velocities are relative to the current vehicle heading. | */
    BODY_OFFSET_NED=17, /* Positions and velocities are relative to the vehicles current position and heading. | */
    BODY_OFFSET_ENU=18, /* Positions and velocities are relative to the vehicles current position and heading. | */
};

//! UXV_FRAME ENUM_END
constexpr auto UXV_FRAME_ENUM_END = 19;
