...
static inline uint16_t mace_msg_guided_target_stats_pack(uint8_t system_id, uint8_t component_id, mace_message_t* msg,
                               float x, float y, float z, float distance, uint8_t coordinate_frame)
{
...
{
    return mace_msg_guided_target_stats_pack(system_id, component_id, msg, guided_target_stats->x, guided_target_stats->y, guided_target_stats->z, guided_target_stats->distance, guided_target_stats->coordinate_frame);
}
...
{
    return mace_msg_guided_target_stats_pack_chan(system_id, component_id, chan, msg, guided_target_stats->x, guided_target_stats->y, guided_target_stats->z, guided_target_stats->distance, guided_target_stats->coordinate_frame);
}
...
static inline void mace_msg_guided_target_stats_send(mace_channel_t chan, float x, float y, float z, float distance, uint8_t coordinate_frame)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    char buf[MACE_MSG_ID_GUIDED_TARGET_STATS_LEN];
    _mace_put_float(buf, 0, x);
...
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    mace_msg_guided_target_stats_send(chan, guided_target_stats->x, guided_target_stats->y, guided_target_stats->z, guided_target_stats->distance, guided_target_stats->coordinate_frame);
#else
 ...
 */
static inline void mace_msg_guided_target_stats_send_buf(mace_message_t *msgbuf, mace_channel_t chan,  float x, float y, float z, float distance, uint8_t coordinate_frame)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
