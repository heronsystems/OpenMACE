...
#define MACE_MSG_ID_AUCTION_TASK_KEY_ACK_LEN 12
#define MACE_MSG_ID_AUCTION_TASK_KEY_ACK_MIN_LEN 12
#define MACE_MSG_ID_10006_LEN 12
#define MACE_MSG_ID_10006_MIN_LEN 12

#define MACE_MSG_ID_AUCTION_TASK_KEY_ACK_CRC 43
#define MACE_MSG_ID_10006_CRC 43
...
#define MACE_MESSAGE_INFO_AUCTION_TASK_KEY_ACK { \
    ...
    {  { "creatorID", NULL, MACE_TYPE_UINT64_T, 0, 0, offsetof(mace_auction_task_key_ack_t, creatorID) }, \
         { "taskID", NULL, MACE_TYPE_UINT32_T, 0, 8, offsetof(mace_auction_task_key_ack_t, taskID) }, \
         } \
}
#else
#define MACE_MESSAGE_INFO_AUCTION_TASK_KEY_ACK { \
...
static inline void mace_msg_auction_task_key_ack_send(mace_channel_t chan, uint64_t creatorID, uint32_t taskID)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    char buf[MACE_MSG_ID_AUCTION_TASK_KEY_ACK_LEN];
    _mace_put_uint64_t(buf, 0, creatorID);
 ...
 */
static inline void mace_msg_auction_task_key_ack_send_buf(mace_message_t *msgbuf, mace_channel_t chan,  uint64_t creatorID, uint32_t taskID)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
 ...
 */
static inline uint32_t mace_msg_auction_task_key_ack_get_taskID(const mace_message_t* msg)
{
