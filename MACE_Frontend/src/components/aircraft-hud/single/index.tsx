...
export default React.memo((props: Props) => {
    ...
    const [selectedBatteryValue, setSelectedBatteryValue] = React.useState("percent");
        ...
        <div style={styles.container}>
            ...
            <div style={styles.hudData}>
                ...
                >
                    ...
                    <div style={styles.hudElement}>
                        <button style={styles.centerButton} data-for={props.data.agentID + "_battery_tooltip"} data-tip='custom show' data-event='click'>
                            {getBatteryIcon()}
                            ...
                            <span style={styles.hudValue && {color: getBatteryTextColor(fields["battery_remaining"])}}>{getBatteryStringValue()}</span>
                        </button>
                        <ReactTooltip id={props.data.agentID + "_battery_tooltip"} place='left' globalEventOff='click' clickable={true} backgroundColor={colors.white}>
                            <form>
            ...
            <div style={styles.hudData}>
                ...
                >
                    ...
                    <div style={styles.hudElement}>
                        ...
                        <span style={styles.hudValue}>{getStringValue(fields["airspeed"].toFixed(2)) + " m/s"}</span>
                    </div>
                ...
                <div>
                    <div style={styles.hudData}>
                        ...
                        >
                            <div style={styles.hudElement}>
                                <span>Roll: </span>
                                <span style={styles.hudValue}>{getStringValue(fields["roll"].toFixed(2))}</span>
                            </div>
                            <div style={styles.hudElement}>
                                <span>Pitch: </span>
                                <span style={styles.hudValue}>{getStringValue(fields["pitch"].toFixed(2))}</span>
                            </div>
                            <div style={styles.hudElement}>
                                <span>Yaw: </span>
                                <span style={styles.hudValue}>{getStringValue(fields["yaw"].toFixed(2))}</span>
                            </div>
                    ...
                    <div style={styles.hudData}>
                        ...
                        >
                            <div style={styles.hudElement}>
                                <span>GPS: </span>
                                <span style={styles.hudValue}>{getStringValue(fields["gps_fix"])}</span>
                            </div>
                            <div style={styles.hudElement}>
                                <span>Distance: </span>
                                <span style={styles.hudValue}>{getStringValue(fields["distance_to_target"].toFixed(2))}</span>
                            </div>
                        </div>
                    </div>
            ...
            <div style={styles.commandsContainer}>
                <div style={styles.commandButtons}>
                    ...
                    { showButton().takeoff.show &&
                    <ReactTooltip id={props.data.agentID + "_takeoff_tooltip"} place='left' globalEventOff='click' clickable={true} backgroundColor={colors.white}>
