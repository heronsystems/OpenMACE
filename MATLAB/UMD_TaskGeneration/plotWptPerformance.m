...
%% default, double integrator optimized
% optimize free parameters are kp, kd, umax
lb = [0 0 0 0 0];
ub = [20 20 3 3 10];
x0 = [2.8156   13.8507    0.3782    0.7167];
kp_kd_umax_opt = fmincon(@(p) wptFollowCostFunc_doubleint(p,params,t,x,xd,yd), x0, [], [], [], [], lb, ub);
