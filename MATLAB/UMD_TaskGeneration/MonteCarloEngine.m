...
% options are 'sim' or 'plot' or 'analysis', or 'analysisPlot'
...
kk = 1;
for ii = [1]  % 3 algorithms
    for m = [2] % 3 maps 
    for jj = 1:1 % total target motions
        if strcmp(simulationOrPlot,'sim')
            ...
            % run main program            
            main_taskGeneration;
            clearvars -except simulationOrPlot ii kk jj m MonteCarloSwitch;
            simulationOrPlot = 'sim';
