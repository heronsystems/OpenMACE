function plotPerformanceMonteCarlo(swarmWorldHist, swarmStateHist, targetStateHist, trueWorld, runParams, swarmModel, targetModel )
...
figure;
subplot(3,1,1)
imagesc(trueWorld.xcp,trueWorld.ycp,swarmWorld.priorP);
hold on;
set(gca,'YDir','Normal')
set(gca,'FontSize',16)
title('Prob {C = Void}')
...
subplot(3,1,2)
imagesc(trueWorld.xcp,trueWorld.ycp,swarmWorld.priorQ);
hold on;
set(gca,'YDir','Normal')
set(gca,'FontSize',16)
...
axis equal; axis tight; colorbar; caxis([0 1]);
subplot(3,1,3) 
imagesc(trueWorld.xcp,trueWorld.ycp,swarmWorld.priorR);
hold on;
set(gca,'YDir','Normal')
set(gca,'FontSize',16)
