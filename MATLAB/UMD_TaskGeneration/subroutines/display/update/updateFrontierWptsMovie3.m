function plotHandles  = updateFrontierWptsMovie3( swarmWorld, swarmState, targetState, trueWorld, runParams, swarmModel, targetModel, plotHandles)
...
switch swarmModel.communicationTopology
    case 'allToAll'
        ...
        set(plotHandles.figh_subplot2,'CData', swarmWorld{3}.cellStateMat);
        ...
        if ( strcmp(swarmModel.mapping.method,'frontierAndBlob') )
            set(plotHandles.figh_sublobCentroid,'XData',swarmWorld{3}.subblobCentroid(:,1),'YData',swarmWorld{3}.subblobCentroid(:,2));
        end
