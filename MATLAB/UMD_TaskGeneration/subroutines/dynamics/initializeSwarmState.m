...
if ( strcmp(runParams.type, 'mace') )
    ...
    if strcmp(ROS_MACE.wptCoordinator,'standalone')
        ...
        eval(['!matlab -desktop -r ''standaloneWptCoordinator(' num2str(runParams.T) ',' num2str(swarmModel.Rsense) ',' num2str(swarmModel.bundleSize) ',' num2str(swarmModel.N) ',[' num2str(ROS_MACE.agentIDs) '])'' &']);
