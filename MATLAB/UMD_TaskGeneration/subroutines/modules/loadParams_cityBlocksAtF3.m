...
if ( strcmp(runParams.type, 'mace') )
    ROS_MACE = struct;
    ROS_MACE.operationalAlt = [4 6 2]; % m OR [4 8 2 6]; if running four quads
    ROS_MACE.agentIDs = [1 2 3]; % m OR [1 2 3 4]; if running four quads
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
swarmModel = struct;
swarmModel.N = 3; % number of agents OR 4; if running four quads
