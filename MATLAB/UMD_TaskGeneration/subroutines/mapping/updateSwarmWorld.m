...
tic;
[swarmWorld.V, swarmWorld.U, swarmWorld.O, swarmWorld.peaks, swarmWorld.weights] = updateUnexploredPrior(swarmWorld.cellStateMat, trueWorld.xx, trueWorld.yy, numnodes(swarmWorld.exploredGraph), swarmModel.probAbsentPrior, swarmWorld.V, swarmWorld.U, swarmWorld.O, swarmWorld.edgeDir, swarmModel.inc, swarmModel.npeaks, swarmModel.ax, swarmModel.ay);
