function [cellsInView, signals, cellStateMat, cellMsmtMat ] = simulateMappingSensorNoisy( xcp, ycp, Rsense, x, N, cellStateMat, cellMsmtMat, numNodesMat, communicationTopology, mG, nG )
% Input:
