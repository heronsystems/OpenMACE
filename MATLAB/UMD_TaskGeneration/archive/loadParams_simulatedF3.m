function [runParams, ROS_MACE, trueWorld, swarmModel, targetModel] = loadParams_simulatedF3()

% simulation
runParams = struct;
runParams.type = 'matlab'; % 'matlab' 'mace' 'f3'
runParams.T = 10; % total simulation/mission time
...
swarmModel.taskGeneration = 'voronoiWpts'; % 'randomWpts', 'voronoiWpts', or 'frontierWpts'
