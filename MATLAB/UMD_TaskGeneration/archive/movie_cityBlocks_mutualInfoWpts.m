function movie_cityBlocks_mutualInfoWpts( swarmWorldHist, swarmStateHist, targetStateHist, trueWorld, runParams, swarmModel, targetModel )
figure;
rows = 2;
cols = 1;
...
%   'CellState',
%   'KrigingInterp'
spTypes = {'GroundTruth','MutualInfoWpts'};
