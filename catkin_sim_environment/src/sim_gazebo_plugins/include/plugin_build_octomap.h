...
#include <ros/ros.h>
#include <sim_gazebo_plugins/Octomap.h>
#include <sdf/sdf.hh>
...
class OctomapFromGazeboWorld : public WorldPlugin {
  ...
  */
  void CreateOctomap(const sim_gazebo_plugins::Octomap::Request& msg);
 ...
 private:
  ...
  bool ServiceCallback(sim_gazebo_plugins::Octomap::Request& req,
                       sim_gazebo_plugins::Octomap::Response& res);
};
